...
const Navbar = ({ currentLang, onLanguageToggle }: NavbarProps) => {

  const translations = {
    en: { searchPlaceholder: "Search for skills courses, or school programs...", navLinks: ["Class 6-12", "Skills", "Admission", "Online Batch", "English Centre", "More"], login: "Login" },
    bn: { searchPlaceholder: "স্কিলস কোর্স, কিংবা স্কুল প্রোগ্রাম সার্চ করুন...", navLinks: ["ক্লাস ৬-১২", "স্কিলস", "ভর্তি পরীক্ষা", "অনলাইন ব্যাচ", "ইংলিশ সেন্টার", "আরও"], login: "লগ-ইন" }
  };
  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <nav className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center gap-x-6">
          <a href="#" aria-label="Home" className="flex-shrink-0">
            <Image src="https://cdn.10minuteschool.com/images/svg/10mslogo-svg.svg" alt="10 Minute School Logo" width={160} height={40} priority />
          </a>
          <div className="relative hidden lg:block flex-1">
            <SearchIcon />
            <input
              type="text"
              className="block w-full rounded-full border-gray-200 bg-gray-50 pl-12 pr-4 py-2.5 text-sm placeholder-gray-500 focus:outline-none focus:ring-1"
